...
\boxedanswer{
    ...
    \begin{align*}
        E_1^\infty &= \left(\frac{\hbar^2}{2}\right)\left(\frac{\pi}{L_z}\right)^2 \\ \\
        \eta_n &= \frac{E_n}{E_1^\infty} \text{\qquad(Dimensionless eigenenergy of the $n$\textsuperscript{th} eigenstate.)}\\
...
\boxedanswer{    
    ...
    \begin{align*}
        H_{ij} &= -\frac{1}{\pi^2} \int_0^1 \psi_i^*(\xi) \frac{d^2}{d\xi^2} \psi_j(\xi) d\xi + f\int_0^1 \psi_i^*(\xi)(\xi - 1/2)\phi_j(\xi) d\xi
    \end{align*}
        ...
        H_{1,1} &= 2\pi^2\frac{1}{\pi^2} \int_0^1 \sin^2(\pi\xi) 
             ...
             d\xi \\
                &\begin{aligned}
                    % u &= (\xi - 1/2) \\
                    % du &= d\xi \\
                    % dv &= \sin^2(\pi \xi) = \frac{1}{2}\left[1 - \cos(2\pi\xi)\right]d\xi \\
                    % v &= \sin^2(\pi \xi) = \frac{1}{2}\left[\xi - \frac{1}{2\pi}\sin(2\pi\xi)\right] \\
                    % 2f\int_0^1 (\xi - 1/2)\sin^2(\pi\xi)^2
                    % d\xi &= 2f\left[uv\right]_0^1 - \int_0^1 vdu\\
                    2f\int_0^1 \overbrace{(\xi - 1/2)}^{\text{odd}}\overbrace{\sin^2(\pi\xi)^2 
                }^{\text{even}}d\xi &= 0 \\
                    % \cancel{\left[(\xi-1/2)\frac{1}{2}\left[1-\cos(2\pi\xi)\right]d\xi\right]_0^1}
                    %     -\int_0^1\frac{1}{2}\left[\xi-\frac{1}{2\pi}\sin(2\pi\xi)\right]d\xi \\
                    % 2f\int_0^1(\xi-1/2)\sin^2(\pi\xi)^2
                    %     d\xi&=-\frac{1}{4}\left[\xi^2+\frac{1}{2\pi^2}
                    %     \cos(2\pi\xi)\right]_0^1 \\
                    % 2f\int_0^1(\xi-1/2)\sin^2(\pi\xi)^2
                    %         d\xi&=-\frac{1}{4} \\
                ...
                \end{aligned} \\
        H_{2,2} &= -\frac{1}{\pi^2} \int_0^1 \psi_2^*(\xi) \frac{d^2}{d\xi^2} 
